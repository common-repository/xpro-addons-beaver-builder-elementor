...
// Infobox grid numbers - large.
FLBuilderCSS::rule(
	array(
		'selector' => ".fl-node-$id .tnit-hover-card-grid",
		'media'    => 'large',
		'props'    => array(
			'margin' => ( '' !== $settings->gutter_size_large ) ? '-' . $settings->gutter_size_large / 2 . 'px' : '',
		),
	)
);
...
FLBuilderCSS::rule(
	array(
		...
		'media'    => 'large',
		'props'    => array(
			'flex'         => ( '' !== $settings->grid_numbers_large ) ? 100 / $settings->grid_numbers_large . '%' : '50%',
			'-webkit-flex' => ( '' !== $settings->grid_numbers_large ) ? 100 / $settings->grid_numbers_large . '%' : '50%',
			'-moz-flex'    => ( '' !== $settings->grid_numbers_large ) ? 100 / $settings->grid_numbers_large . '%' : '50%',
			'-ms-flex'     => ( '' !== $settings->grid_numbers_large ) ? 100 / $settings->grid_numbers_large . '%' : '50%',
			'max-width'    => ( '' !== $settings->grid_numbers_large ) ? 100 / $settings->grid_numbers_large . '%' : '50%',
			'padding'      => ( '' !== $settings->gutter_size_large ) ? $settings->gutter_size_large / 2 . 'px' : '',
		),
	)
);
FLBuilderCSS::rule(
